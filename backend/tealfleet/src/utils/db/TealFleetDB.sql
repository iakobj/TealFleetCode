...
CREATE TABLE "sw_categories" (
  "sw_category_id" varchar PRIMARY KEY,
  "category" varchar,
  "created_at" timestamp DEFAULT (now())
);
...
ALTER TABLE "users" ADD FOREIGN KEY ("user_id") REFERENCES "sites" ("site_id");
...
ALTER TABLE "contract_types" ADD FOREIGN KEY ("contract_type_id") REFERENCES "contracts" ("contract_type_id");

ALTER TABLE "tenants" ADD FOREIGN KEY ("tenant_id") REFERENCES "contract_types" ("tenant_id");

ALTER TABLE "sub_navigation" ADD FOREIGN KEY ("sub_navigation_id") REFERENCES "main_navigation" ("main_navigation_id");

ALTER TABLE "software_list" ADD FOREIGN KEY ("software_list_id") REFERENCES "software_assets" ("software_list_id");

ALTER TABLE "software_assets" ADD FOREIGN KEY ("hardware_id") REFERENCES "hardware_assets" ("hardware_asset_id");

ALTER TABLE "software_assets" ADD FOREIGN KEY ("tenant_id") REFERENCES "tenants" ("tenant_id");

ALTER TABLE "sites" ADD FOREIGN KEY ("site_id") REFERENCES "software_assets" ("site_id");

ALTER TABLE "sw_categories" ADD FOREIGN KEY ("sw_category_id") REFERENCES "software_list" ("sw_category_id");

ALTER TABLE "vendors" ADD FOREIGN KEY ("vendor_id") REFERENCES "software_list" ("vendor_id");

ALTER TABLE "hardware_list" ADD FOREIGN KEY ("hardware_list_id") REFERENCES "hardware_assets" ("hardware_list_id");

ALTER TABLE "hardware_assets" ADD FOREIGN KEY ("tenant_id") REFERENCES "tenants" ("tenant_id");

ALTER TABLE "sites" ADD FOREIGN KEY ("site_id") REFERENCES "hardware_assets" ("site_id");

ALTER TABLE "vendors" ADD FOREIGN KEY ("vendor_id") REFERENCES "hardware_list" ("vendor_id");

ALTER TABLE "hw_categories" ADD FOREIGN KEY ("hw_category_id") REFERENCES "hardware_list" ("hw_category_id");

ALTER TABLE "sw_asset_contracts" ADD FOREIGN KEY ("software_asset_id") REFERENCES "contracts" ("contract_id");

ALTER TABLE "sw_asset_contracts" ADD FOREIGN KEY ("contract_id") REFERENCES "software_assets" ("software_asset_id");

ALTER TABLE "hw_asset_contracts" ADD FOREIGN KEY ("hardware_asset_id") REFERENCES "contracts" ("contract_id");

ALTER TABLE "hw_asset_contracts" ADD FOREIGN KEY ("contract_id") REFERENCES "hardware_assets" ("hardware_asset_id");
